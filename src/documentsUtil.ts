...
export class TextDocument {
    ...
    public static fromTestFile(file: TestFile): TextDocument {
    ...
    public asTestFile(): TestFile {
        return this._testFile || (this._testFile = {
            unitName: this.file,
            content: this.text,
            fileOptions: core.arrayFrom(this.meta)
...
export class SourceMap {
    ...
    public static fromUrl(url: string): SourceMap | undefined {
        ...
        return match ? new SourceMap(/*mapFile*/ undefined, core.base64decode!(match[1])) : undefined;
    }
